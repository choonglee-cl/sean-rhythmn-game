...
/******/ 	var hotCurrentHash = "7ddde0d8ba7a911df3fb"; // eslint-disable-line no-unused-vars
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function gameOver() {
      ...
      var gameOverBorder = new createjs.Text("Game over!", "60px Impact", "black");
      gameOverBorder.outline = 2;
      gameOverBorder.x = 225;
      gameOverBorder.y = 275;
      var gameOver = gameOverBorder.clone();
      gameOver.outline = 0;
      gameOver.color = "red";
      this.stage.addChild(gameOver, gameOverBorder);
      this.stage.update();
      setTimeout(function () {
        _this9.stage.removeChild(gameOver, gameOverBorder);
      }, 5000);
      this.clearArrows();
      this.music.pause();
      clearInterval(this.myInt);
    ...
    value: function endGame() {
      ...
      var endGameBorder = new createjs.Text("Song Complete!", "50px Impact", "black");
      endGameBorder.outline = 2;
      endGameBorder.x = 200;
      endGameBorder.y = 275;
      var endGame = endGameBorder.clone();
      endGame.outline = 0;
      endGame.color = "#00ff00";
      this.stage.addChild(endGame, endGameBorder);
      this.stage.update();

      // 3초 후 메인 메뉴로 돌아가기
      setTimeout(function () {
        _this10.stage.removeChild(endGame, endGameBorder);
        window.location.href = "index.html";
      }, 3000);
